        ...
        <ul id="nav">
             <li >
               ...
               <%--  <ul class="sub-menu">
                ...
                <ul class="sub-menu">
                    <li><a _href="singleChoice.jsp"><i class="iconfont">&#xe6a7;</i><cite>单选题</cite></a></li >
                </ul>
                <ul class="sub-menu">
                    <li><a _href="multpleChoice.jsp"><i class="iconfont">&#xe6a7;</i><cite>多选题</cite></a></li >
                </ul>
                <ul class="sub-menu">
                    <li><a _href="html/welcome.html"><i class="iconfont">&#xe6a7;</i><cite>判断题</cite></a></li >
                </ul>
                <ul class="sub-menu">
                    <li><a _href="html/welcome.html"><i class="iconfont">&#xe6a7;</i><cite>填空题</cite></a></li >
                </ul>
                <ul class="sub-menu">
                    <li><a _href="html/welcome.html"><i class="iconfont">&#xe6a7;</i><cite>简答题</cite></a></li >
                </ul>
            </li>
             <li >
                <a href="javascript:;">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a _href="html/unicode.html"><i class="iconfont">&#xe6a7;</i><cite>上传试题</cite></a></li>
                    <li><a _href="html/unicode.html"><i class="iconfont">&#xe6a7;</i><cite>查看试题</cite></a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a _href="html/page.html"><i class="iconfont">&#xe6a7;</i><cite>随机组卷</cite></a></li>
